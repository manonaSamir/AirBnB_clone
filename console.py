...
class HBNBCommand(cmd.Cmd):
    ...
    def do_show(self, line):
       ...
       based on the class name and id"""
        ...
        elif arg[0]+'.'+ids not in storage\
                ._FileStorage__objects.keys():
            print("** no instance found **")
        else:
            print(storage._FileStorage__objects[arg[0]+'.'+ids])
    ...
    def do_destroy(self, line):
        ...
        if not line:
            ...
            del storage._FileStorage__objects[arg[0]+'.'+ids]
            storage.save()
    ...
    def do_update(self, line):
        ...
        if arg[0] not in self.app_command:
            ...
            print("** instance id missing **")
        elif arg[0]+'.'+arg[1] not in storage\
                ._FileStorage__objects.keys():
            print("** no instance found **")
        elif len(line) == 2:
            ...
            obj = storage._FileStorage__objects[arg[0]+'.'+arg[1]]
    ...
    def count(self, line):
        ...
        arg = line.split()
        objects = [key for key in storage.all() if key.startswith(arg[0])]
        print(len(objects))
    ...
    def fun_update(self, cls_name, obj_attr):
        ...
        if "{" in args[1]:
            ...
            for key, val in dictionary.items():
                obj = storage._FileStorage__objects[cls_name +
                                                    '.'+args[0].strip('" ')]
            ...
            if len(args[0]) < 1:
                print("** instance id missing **")
            elif cls_name+'.'+obj_id not in storage\
                    ._FileStorage__objects.keys():
                print("** no instance found **")
            elif len(args[1]) < 1:
                print("** attribute name missing **")
                ...
                obj = storage._FileStorage__objects[cls_name+'.'+obj_id]
